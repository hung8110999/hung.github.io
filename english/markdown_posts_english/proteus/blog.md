...
![amino_acid](image/aminoacid.png){width=50%}
...
![types](image/aminoacid_types.png){width=20%}
...
![protein](image/protein.png){width=20%}
...
![protein_folding](image/folding.png){width=40%}
